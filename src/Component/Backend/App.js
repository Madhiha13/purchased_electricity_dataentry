...
app.post('/purchasedelectricity_dataentry', (req, res) => {
  const { year, month, facilityCode, facilityName, ElectricityType, Consumption, siUnits, fileUrl } = req.body;
...
app.get('/purchasedelectricity_dataentry', (req, res) => {
  const dataEntries = readDataEntries();
...
console.log("your endpoint will be: http://localhost:5000/purchasedelectricity_dataentry");